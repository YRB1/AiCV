...
const TRANSLATIONS = {
  ...
  // TESTIMONIALS
  'testi1.text': { en: '"I spent 3 months applying manually with zero responses. Within a week of using Blitzbewerbung, I had 4 interviews booked. The AI cover letters are insanely good — they genuinely sound like me."', de: '„Ich habe 3 Monate manuell beworben und keine Antwort erhalten. Nach einer Woche mit Blitzbewerbung hatte ich 4 Interviews gebucht. Die KI-Anschreiben sind unglaublich gut — sie klingen wirklich nach mir."' },
  'testi1.role': { en: 'Software Engineering Apprentice, Google', de: 'Software-Engineering-Lernende·r, Google' },
  'testi2.text': { en: '"The time I save is insane. I used to spend 2–3 hours writing one cover letter. Now I approve 10 applications before breakfast. Just got my offer from Deloitte — couldn\'t have done it without this."', de: '„Die Zeit, die ich spare, ist unglaublich. Früher habe ich 2–3 Stunden für ein Anschreiben gebraucht. Jetzt genehmige ich 10 Bewerbungen vor dem Frühstück. Gerade mein Angebot von Deloitte bekommen — ohne Blitzbewerbung hätte ich es nicht geschafft."' },
  'testi2.role': { en: 'Business Analyst Apprentice, Deloitte', de: 'Business-Analyst-Lernende·r, Deloitte' },
  'testi3.text': { en: '"As someone with no connections and no idea where to start, Blitzbewerbung levelled the playing field. The AI found opportunities I never would\'ve found myself. Landed at HSBC in my first month!"', de: '„Als jemand ohne Netzwerk und ohne Ahnung, wo ich anfangen soll, hat Blitzbewerbung die Chancen ausgeglichen. Die KI fand Möglichkeiten, die ich selbst nie gefunden hätte. Im ersten Monat bei HSBC gelandet!"' },
  'testi3.role': { en: 'Data Science Apprentice, HSBC', de: 'Data-Science-Lernende·r, HSBC' },
  'testi4.text': { en: '"I\'m not the most confident writer but Blitzbewerbung makes every application sound polished and professional. Got 6 interviews in 2 weeks — my friends couldn\'t believe it."', de: '„Ich bin kein selbstsicherer Schreiber, aber Blitzbewerbung lässt jede Bewerbung professionell klingen. In 2 Wochen 6 Interviews bekommen — meine Freunde konnten es nicht glauben."' },
  'testi4.role': { en: 'Marketing Apprentice, PwC', de: 'Marketing-Lernende·r, PwC' },
  'testi5.text': { en: '"The interview prep feature alone is worth the Pro price. It gave me exact questions that came up in my Amazon interview. Walked in confident and got the offer."', de: '„Die Interview-Vorbereitung allein ist den Pro-Preis wert. Sie gab mir genau die Fragen, die in meinem Amazon-Interview auftauchten. Selbstsicher reingegangen und das Angebot bekommen."' },
  'testi5.role': { en: 'Cloud Support Apprentice, Amazon', de: 'Cloud-Support-Lernende·r, Amazon' },
  'testi6.text': { en: '"I was applying for finance apprenticeships and the AI completely transformed my cover letters. They sounded so much more professional than anything I could write myself. IBM offered me the role within 3 weeks."', de: '„Ich habe mich für Finanz-Lehrstellen beworben und die KI hat meine Anschreiben komplett transformiert. Sie klangen viel professioneller als alles, was ich selbst schreiben konnte. IBM bot mir die Stelle innerhalb von 3 Wochen an."' },
  'testi6.role': { en: 'Finance Technology Apprentice, IBM', de: 'Fintech-Lernende·r, IBM' },
  ...
  'demo.submitted':   { en: 'Application submitted to Google ✓',            de: 'Bewerbung bei Google abgesendet ✓' },
  ...
  'demo.interview':   { en: '🎉 Interview booked with Google — Monday 9am', de: '🎉 Interview bei Google gebucht — Montag 9 Uhr' },
